...
class TestIsPlayable(unittest.TestCase):
    ...
    def test_three_of_a_kind_invalid(self):
        self.assertIs(
            is_playable(Category.THREE_OF_A_KIND, Combo([2, 2, 3, 4, 5]), self.card),
            False,
        )

    def test_four_of_a_kind_invalid(self):
        self.assertIs(
            is_playable(Category.FOUR_OF_A_KIND, Combo([5, 5, 5, 2, 2]), self.card),
            False,
        )
    ...
    def test_small_straight_invalid(self):
        self.assertIs(
            is_playable(Category.SMALL_STRAIGHT, Combo([1, 1, 3, 4, 6]), self.card),
            False,
        )
    ...
    def test_large_straight_invalid(self):
        self.assertIs(
            is_playable(Category.LARGE_STRAIGHT, Combo([1, 2, 2, 4, 5]), self.card),
            False,
        )
